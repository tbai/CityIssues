...
<html lang="pt-BR">
  <head>
    ...
    <link rel="stylesheet" href="${resource(dir:'js/jquery/ui/css/redmond-custom',file:'jquery-ui-1.8.11.custom.css')}" />
    <link rel="stylesheet" href="${resource(dir:'css/layout',file:'basicHeader.css')}" />
